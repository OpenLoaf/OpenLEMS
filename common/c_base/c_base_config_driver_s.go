...
type SDeviceConfig struct {
	...
	StorageRetentionDays int               `json:"storageRetentionDays" orm:"storage_retention_days"` // 存储天数
	...
	//DeviceChildren     []*SDeviceConfig  `json:"deviceChildren,omitempty" orm:"with:parent_id=id"` // 子设备
