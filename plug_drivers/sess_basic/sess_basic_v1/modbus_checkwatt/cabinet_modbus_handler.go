...
func updateValue[T util.Number](index uint16, result []uint16, wg *sync.WaitGroup, factor, offset T, fc func() (T, error)) {
...
func updateDoubleValue[T util.Number](index uint16, result []uint16, wg *sync.WaitGroup, factor, offset T, fc func() (T, error)) {
