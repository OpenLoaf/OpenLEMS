...
// 非定时读取的任务
var (
	SyGroupStatistics = &p_modbus.ModbusGroup{
	...
	SyGroupTime = &p_modbus.ModbusGroup{
		Name:      "TimeGroup",
		Desc:      "查询年月日时分秒",
		Addr:      Year.Addr,
	...
	SyGroupSoftwareVersion = &p_modbus.ModbusGroup{
	...
	GroupPhase = &p_modbus.ModbusGroup{
		Name:      "GroupPhase",
		Desc:      "查询相位信息",
...
// 定时读取的任务
var (
	GroupStatus = &p_modbus.ModbusGroup{
		Name:      "GroupStatus",
		Desc:      "查询PCS状态信息",
	...
	GroupCommand = &p_modbus.ModbusGroup{
		Name:      "GroupCommand",
		Desc:      "控制命令",
	...
	GroupPowerInfo = &p_modbus.ModbusGroup{
		Name:      "GroupPowerInfo",
		Desc:      "查询功率信息",
	...
	GroupSerial = &p_modbus.ModbusGroup{
		Name:      "GroupSerial",
		Desc:      "查询Pcs序列信息",
	...
	GroupGridModeSetting = &p_modbus.ModbusGroup{
	...
	GroupTemperature = &p_modbus.ModbusGroup{
	...
	GroupOtherStatus = &p_modbus.ModbusGroup{
		Name:      "GroupStatus",
		Desc:      "查询PCS状态信息",
