...
func TestEncodeValueToRegisters(t *testing.T) {
	tests := []struct {
		...
		{int32(123456789), c_enum.EInt32, []uint16{1883, 52501}},   // 大端字节序
		{float32(3.14159), c_enum.EFloat32, []uint16{16457, 4048}}, // 大端字节序
	}
...
func TestDecodeRegistersToValue(t *testing.T) {
	tests := []struct {
		...
		{[]uint16{1883, 52501}, c_enum.EInt32, int32(123456789)},
		{[]uint16{16457, 4048}, c_enum.EFloat32, float32(3.14159)},
	}
