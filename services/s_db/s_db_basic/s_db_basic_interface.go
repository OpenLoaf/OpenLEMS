...
type IAutomationService interface {
	// 基础 CRUD 方法
	CreateAutomation(ctx context.Context, startTime, endTime *time.Time, timeRangeType, timeRangeValue, triggerRule, executeRule string, executionInterval int) (int, error)
