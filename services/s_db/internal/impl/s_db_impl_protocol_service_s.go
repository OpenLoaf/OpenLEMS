...
func (s *sProtocolServiceImpl) GetAllProtocolConfigs(ctx context.Context) (data []*c_base.SProtocolConfig, err error) {
	list, err := s.GetProtocolList(ctx, "")
	if err != nil {
		return
	}
	err = gconv.Scan(list, &data)
	return
}
