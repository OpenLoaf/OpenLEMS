...
func (i *Influxdb2) SaveSystemMetrics(measurement string, tags map[string]string, metrics map[string]any) error {
	return i.write(systemBucket, measurement, tags, metrics)
}
