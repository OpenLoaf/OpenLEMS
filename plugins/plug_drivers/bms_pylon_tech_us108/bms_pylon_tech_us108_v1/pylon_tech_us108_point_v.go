...
var (
	...
	SystemErrorProtection = &c_proto.SModbusPoint{Addr: 0x1100, SPoint: &c_base.SPoint{Key: "SystemErrorProtection", Name: "系统故障保护", Group: StatusGroup, Level: c_enum.EAlarmLevelError, Desc: "0-正常；1-保护"}, DataAccess: &c_base.SDataAccess{BitIndex: 3, BitLength: 1, DataFormat: c_enum.DataFormatBitRange, ByteEndian: c_enum.ByteEndianBig, WordOrder: c_enum.WordOrderHighLow, ValueType: c_enum.EBool}, StatusExplain: c_func.StatusExplainProtectFunc}
	CurrentProtection     = &c_proto.SModbusPoint{Addr: 0x1100, SPoint: &c_base.SPoint{Key: "CurrentProtection", Name: "电流保护", Group: StatusGroup, Level: c_enum.EAlarmLevelError, Desc: "0-正常；1-保护"}, DataAccess: &c_base.SDataAccess{BitIndex: 4, BitLength: 1, DataFormat: c_enum.DataFormatBitRange, ByteEndian: c_enum.ByteEndianBig, WordOrder: c_enum.WordOrderHighLow, ValueType: c_enum.EBool}, StatusExplain: c_func.StatusExplainProtectFunc}
	VoltageProtection     = &c_proto.SModbusPoint{Addr: 0x1100, SPoint: &c_base.SPoint{Key: "VoltageProtection", Name: "电压保护", Group: StatusGroup, Level: c_enum.EAlarmLevelError, Desc: "0-正常；1-保护"}, DataAccess: &c_base.SDataAccess{BitIndex: 5, BitLength: 1, DataFormat: c_enum.DataFormatBitRange, ByteEndian: c_enum.ByteEndianBig, WordOrder: c_enum.WordOrderHighLow, ValueType: c_enum.EBool}, StatusExplain: c_func.StatusExplainProtectFunc}
	TemperatureProtection = &c_proto.SModbusPoint{Addr: 0x1100, SPoint: &c_base.SPoint{Key: "TemperatureProtection", Name: "温度保护", Group: StatusGroup, Level: c_enum.EAlarmLevelError, Desc: "0-正常；1-保护"}, DataAccess: &c_base.SDataAccess{BitIndex: 6, BitLength: 1, DataFormat: c_enum.DataFormatBitRange, ByteEndian: c_enum.ByteEndianBig, WordOrder: c_enum.WordOrderHighLow, ValueType: c_enum.EBool}, StatusExplain: c_func.StatusExplainProtectFunc}
	VoltageAlarm          = &c_proto.SModbusPoint{Addr: 0x1100, SPoint: &c_base.SPoint{Key: "VoltageAlarm", Name: "电压警告", Group: StatusGroup, Level: c_enum.EAlarmLevelAlarm, Desc: "0-正常；1-保护"}, DataAccess: &c_base.SDataAccess{BitIndex: 7, BitLength: 1, DataFormat: c_enum.DataFormatBitRange, ByteEndian: c_enum.ByteEndianBig, WordOrder: c_enum.WordOrderHighLow, ValueType: c_enum.EBool}, StatusExplain: c_func.StatusExplainProtectFunc}
	CurrentAlarm          = &c_proto.SModbusPoint{Addr: 0x1100, SPoint: &c_base.SPoint{Key: "CurrentAlarm", Name: "电流警告", Group: StatusGroup, Level: c_enum.EAlarmLevelAlarm, Desc: "0-正常；1-保护"}, DataAccess: &c_base.SDataAccess{BitIndex: 8, BitLength: 1, DataFormat: c_enum.DataFormatBitRange, ByteEndian: c_enum.ByteEndianBig, WordOrder: c_enum.WordOrderHighLow, ValueType: c_enum.EBool}, StatusExplain: c_func.StatusExplainProtectFunc}
	TemperatureAlarm      = &c_proto.SModbusPoint{Addr: 0x1100, SPoint: &c_base.SPoint{Key: "TemperatureAlarm", Name: "温度警告", Group: StatusGroup, Level: c_enum.EAlarmLevelAlarm, Desc: "0-正常；1-保护"}, DataAccess: &c_base.SDataAccess{BitIndex: 9, BitLength: 1, DataFormat: c_enum.DataFormatBitRange, ByteEndian: c_enum.ByteEndianBig, WordOrder: c_enum.WordOrderHighLow, ValueType: c_enum.EBool}, StatusExplain: c_func.StatusExplainProtectFunc}
	...
	ErrorCode1                                      = &c_proto.SModbusPoint{Addr: 0x1132, SPoint: c_default.VPointErrorCode, DataAccess: c_default.VDataAccessInt16, Trigger: c_func.IsNotZero}
	ErrorCode2                                      = &c_proto.SModbusPoint{Addr: 0x1134, SPoint: c_default.VPointErrorCode, DataAccess: c_default.VDataAccessInt16, Trigger: c_func.IsNotZero}
	...
	AlarmStatus2           = &c_proto.SModbusPoint{Addr: 0x114E, SPoint: &c_base.SPoint{Key: "AlarmStatus2", Name: "告警状态2"}, DataAccess: c_default.VDataAccessInt16, Trigger: c_func.IsNotZero}
