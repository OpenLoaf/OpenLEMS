...
type sPylonTechUs108BmsConfig struct {
	...
	MaxInputPower  *uint32 `json:"maxInputPower" name:"最大输入功率" ct:"number" v:"min:0" unit:"kW" step:"1"`                             // 最大输入功率
	MaxOutputPower *uint32 `json:"maxOutputPower" name:"最大输出功率" ct:"number" v:"min:0" unit:"kW" step:"1"`                            // 最大输出功率
}
