...
type sPylonTechUs108BmsConfig struct {
	...
	RatedPower     *uint32 `json:"ratedPower input_type:" name:"额定功率" min:"0" max:"1000" step:"10" default:"100"  unit:"kW"` // 额定功率
	Capacity       *uint32 `json:"capacity" min:"0" name:"容量" max:"2000" default:"232"  unit:"kWh" step:"1"`                 // 容量
	MaxInputPower  *uint32 `json:"maxInputPower" name:"最大输入功率" min:"0" unit:"kW"  step:"1"`                                  // 最大输入功率
	MaxOutputPower *uint32 `json:"maxOutputPower" name:"最大输出功率" min:"0" unit:"kW"  step:"1"`                                 // 最大输出功率
}
