...
// 非定时读取的任务
var (
	SyGroupStatistics = &c_proto.SModbusTask{
	...
	SyGroupTime = &c_proto.SModbusTask{
		Name:      "TimeGroup",
		Desc:      "查询年月日时分秒",
		Addr:      Year.Addr,
	...
	SyGroupSoftwareVersion = &c_proto.SModbusTask{
	...
	GroupPhase = &c_proto.SModbusTask{
		Name:      "GroupPhase",
		Desc:      "查询相位信息",
...
// 定时读取的任务
var (
	GroupStatus = &c_proto.SModbusTask{
		Name:      "GroupStatus",
		Desc:      "查询PCS状态信息",
	...
	GroupCommand = &c_proto.SModbusTask{
		Name:      "GroupCommand",
		Desc:      "控制命令",
	...
	GroupPowerInfo = &c_proto.SModbusTask{
		Name:      "GroupPowerInfo",
		Desc:      "查询功率信息",
	...
	GroupSerial = &c_proto.SModbusTask{
		Name:      "GroupSerial",
		Desc:      "查询Pcs序列信息",
	...
	GroupGridModeSetting = &c_proto.SModbusTask{
	...
	GroupTemperature = &c_proto.SModbusTask{
	...
	GroupOtherStatus = &c_proto.SModbusTask{
		Name:      "GroupStatus",
		Desc:      "查询PCS状态信息",
