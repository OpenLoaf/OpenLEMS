...
// 非定时读取的任务
var (
	SyGroupStatistics = &c_modbus.SModbusTask{
	...
	SyGroupTime = &c_modbus.SModbusTask{
		Name:      "TimeGroup",
		Desc:      "查询年月日时分秒",
		Addr:      Year.Addr,
	...
	SyGroupSoftwareVersion = &c_modbus.SModbusTask{
	...
	GroupPhase = &c_modbus.SModbusTask{
		Name:      "GroupPhase",
		Desc:      "查询相位信息",
...
// 定时读取的任务
var (
	GroupStatus = &c_modbus.SModbusTask{
		Name:      "GroupStatus",
		Desc:      "查询PCS状态信息",
	...
	GroupCommand = &c_modbus.SModbusTask{
		Name:      "GroupCommand",
		Desc:      "控制命令",
	...
	GroupPowerInfo = &c_modbus.SModbusTask{
		Name:      "GroupPowerInfo",
		Desc:      "查询功率信息",
	...
	GroupSerial = &c_modbus.SModbusTask{
		Name:      "GroupSerial",
		Desc:      "查询Pcs序列信息",
	...
	GroupGridModeSetting = &c_modbus.SModbusTask{
	...
	GroupTemperature = &c_modbus.SModbusTask{
	...
	GroupOtherStatus = &c_modbus.SModbusTask{
		Name:      "GroupStatus",
		Desc:      "查询PCS状态信息",
