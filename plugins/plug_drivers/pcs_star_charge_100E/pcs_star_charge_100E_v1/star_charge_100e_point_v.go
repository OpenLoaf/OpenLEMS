...
var (
	...
	TotalActivePowerInverterSide   = &c_proto.SModbusPoint{Addr: 30353, SPoint: &c_base.SPoint{Key: "TotalActivePowerInverterSide", Name: "逆变器侧总有功功率", Unit: "kW", Desc: "CurrentTotal active power on the inverter side"}, DataAccess: &c_base.SDataAccess{DataFormat: c_enum.DataFormatInt32, ByteEndian: c_enum.ByteEndianBig, WordOrder: c_enum.WordOrderHighLow, ValueType: c_enum.EFloat64, Factor: 0.001}}
	TotalReactivePowerInverterSide = &c_proto.SModbusPoint{Addr: 30355, SPoint: &c_base.SPoint{Key: "TotalReactivePowerInverterSide", Name: "逆变器侧总无功功率", Unit: "kVar", Desc: "CurrentTotal reactive power on the inverter side"}, DataAccess: &c_base.SDataAccess{DataFormat: c_enum.DataFormatInt32, ByteEndian: c_enum.ByteEndianBig, WordOrder: c_enum.WordOrderHighLow, ValueType: c_enum.EFloat64, Factor: 0.001}}
	TotalApparentPowerInverterSide = &c_proto.SModbusPoint{Addr: 30357, SPoint: &c_base.SPoint{Key: "TotalApparentPowerInverterSide", Name: "逆变器侧总视在功率", Unit: "kVA", Desc: "CurrentTotal apparent power on the inverter side"}, DataAccess: &c_base.SDataAccess{DataFormat: c_enum.DataFormatInt32, ByteEndian: c_enum.ByteEndianBig, WordOrder: c_enum.WordOrderHighLow, ValueType: c_enum.EFloat64, Factor: 0.001}}
