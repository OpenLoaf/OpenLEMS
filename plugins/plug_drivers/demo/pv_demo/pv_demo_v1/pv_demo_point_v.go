...
var (
	...
	PowerLimit        = &c_base.Meta{Name: "PowerLimit", Cn: "功率限制值", Addr: 0x0068, ReadType: c_base.RInt16, Factor: 0.1, Unit: "kW"}
	InstalledCapacity = &c_base.Meta{Name: "InstalledCapacity", Cn: "装机容量", Addr: 0x0069, ReadType: c_base.RInt16, Factor: 0.1, Unit: "kW"}
	Irradiance        = &c_base.Meta{Name: "Irradiance", Cn: "当前辐照度", Addr: 0x006A, ReadType: c_base.RInt16, Factor: 0.1, Unit: "W/m²"}
	Temperature       = &c_base.Meta{Name: "Temperature", Cn: "当前温度", Addr: 0x006B, ReadType: c_base.RInt16, Factor: 0.1, Unit: "°C"}
	Efficiency        = &c_base.Meta{Name: "Efficiency", Cn: "转换效率", Addr: 0x006C, ReadType: c_base.RInt16, Factor: 0.01}
)
