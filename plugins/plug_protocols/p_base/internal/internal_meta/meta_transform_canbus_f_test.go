...
func TestName(t *testing.T) {
	...
	Level2Alarm := &c_base.Meta{Name: "Level2Alarm", Cn: "2级报警", Addr: 1, ReadType: c_base.RBit6, SystemType: c_base.SBool, Unit: "", Desc: "位 1 -报警 位 0 -正常", Trigger: c_func.IsNotZero}
	GasCapsuleHardwareFault := &c_base.Meta{Name: "GasCapsuleHardwareFault", Cn: "气溶胶硬件故障", Addr: 2, ReadType: c_base.RBit1, SystemType: c_base.SBool, Unit: "", Desc: "位 1 -故障 位 0 -正常", Trigger: c_func.IsNotZero}
	MainCircuitVoltageFault := &c_base.Meta{Name: "MainCircuitVoltageFault", Cn: "主电欠压故障", Addr: 2, ReadType: c_base.RBit2, SystemType: c_base.SBool, Unit: "", Desc: "位 1 -故障 位 0 -正常", Trigger: c_func.IsNotZero}
